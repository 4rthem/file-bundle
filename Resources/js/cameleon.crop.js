        ...
        init: function ($c, options) {
                ...
                $fileInput
                    ...
                    .on('fileuploaddone', function (e, data) {
                        if (data.result.file) {
                            ...
                            Arthem.request.alertError(data.result.errors.join(', '));
                        }
                        if (settings.progress) {
            ...
            function turnOn() {
                ...
                $saveBtn.click(function () {
                    displayProgressBar();
                    $actions.hide();
                    Arthem.request.post(settings.cropUrl, {
            ...
            if (settings.deleteUrl) {
                $c.find(settings.deleteBtnSelector).click(function (e) {
                    ...
                    if (settings.imageId && confirm(settings.deleteConfirmText)) {
                        Arthem.request['delete'](settings.deleteUrl, {
                                id: settings.imageId
                            }, function () {
